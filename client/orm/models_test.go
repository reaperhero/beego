...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/reaperhero/beego/v2/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/reaperhero/beego/v2/client/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go get -u github.com/reaperhero/beego/v2/client/orm
	...
	go test -v github.com/reaperhero/beego/v2/client/orm
	...
	go test -v github.com/reaperhero/beego/v2/pgk/orm
